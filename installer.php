...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230306_progettonespresso_54b20f51940199665044_20230306165925_archive.zip';
        const ARCHIVE_SIZE       = '294346';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '54b20f5-06165925';
        const SECONDARY_PACKAGE_HASH = 'f61b56b-06165925';
